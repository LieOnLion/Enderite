...
public class ItemsInit {
    public static final Item ENDERITE_INGOT = registerItem("enderite_ingot", new Item(new FabricItemSettings().fireproof()));
    public static final Item ENDERITE_FRAGMENT = registerItem("enderite_fragment", new Item(new FabricItemSettings().fireproof()));
    public static final BlockItem ENDERITE_BLOCK_ITEM = (BlockItem) registerItem("enderite_block",
            new BlockItem(BlocksInit.ENDERITE_BLOCK, new FabricItemSettings().fireproof()));
    public static final BlockItem PRIMORDIAL_REMNANTS_ITEM = (BlockItem) registerItem("primordial_remnants",
            new BlockItem(BlocksInit.PRIMORDIAL_REMNANTS, new FabricItemSettings().fireproof()));
    public static final BlockItem OBSIDIAN_INFUSED_ENDERITE_BLOCK_ITEM = (BlockItem) registerItem("obsidian_infused_enderite_block",
            new BlockItem(BlocksInit.OBSIDIAN_INFUSED_ENDERITE_BLOCK, new FabricItemSettings().fireproof()));
    ...
    public static final Item ENDERITE_SWORD = registerItem("enderite_sword",
            new SwordItem(ToolMaterialsInit.ENDERITE, 2, -1.9f, new FabricItemSettings().fireproof()));
    public static final Item ENDERITE_SHOVEL = registerItem("enderite_shovel",
            new ShovelItem(ToolMaterialsInit.ENDERITE, 0.5f, -2.5f, new FabricItemSettings().fireproof()));
    public static final Item ENDERITE_PICKAXE = registerItem("enderite_pickaxe",
            new PickaxeItem(ToolMaterialsInit.ENDERITE, 0, -2.3f, new FabricItemSettings().fireproof()));
    public static final Item ENDERITE_AXE = registerItem("enderite_axe",
            new AxeItem(ToolMaterialsInit.ENDERITE, 4, -2.5f, new FabricItemSettings().fireproof()));
    public static final Item ENDERITE_HOE = registerItem("enderite_hoe",
            new HoeItem(ToolMaterialsInit.ENDERITE, -6, .5f, new FabricItemSettings().fireproof()));

    public static final Item ENDERITE_HELMET = registerItem("enderite_helmet",
            new ArmorItem(ArmorMaterialsInit.ENDERITE, ArmorItem.Type.HELMET, new FabricItemSettings().fireproof()));
    public static final Item ENDERITE_CHESTPLATE = registerItem("enderite_chestplate",
            new ArmorItem(ArmorMaterialsInit.ENDERITE, ArmorItem.Type.CHESTPLATE, new FabricItemSettings().fireproof()));
    public static final Item ENDERITE_LEGGINGS = registerItem("enderite_leggings",
            new ArmorItem(ArmorMaterialsInit.ENDERITE, ArmorItem.Type.LEGGINGS, new FabricItemSettings().fireproof()));
    public static final Item ENDERITE_BOOTS = registerItem("enderite_boots",
            new ArmorItem(ArmorMaterialsInit.ENDERITE, ArmorItem.Type.BOOTS, new FabricItemSettings().fireproof()));

    public static final Item OBSIDIAN_INFUSED_ENDERITE_INGOT = registerItem("obsidian_infused_enderite_ingot", new Item(new FabricItemSettings().fireproof()));

    public static final Item OBSIDIAN_INFUSED_ENDERITE_SWORD = registerItem("obsidian_infused_enderite_sword",
            new SwordItem(ToolMaterialsInit.OBSIDIAN_INFUSED_ENDERITE, 3, -1.4f, new FabricItemSettings().fireproof()));
    public static final Item OBSIDIAN_INFUSED_ENDERITE_SHOVEL = registerItem("obsidian_infused_enderite_shovel",
            new ShovelItem(ToolMaterialsInit.OBSIDIAN_INFUSED_ENDERITE, 1.5f, -2f, new FabricItemSettings().fireproof()));
    public static final Item OBSIDIAN_INFUSED_ENDERITE_PICKAXE = registerItem("obsidian_infused_enderite_pickaxe",
            new PickaxeItem(ToolMaterialsInit.OBSIDIAN_INFUSED_ENDERITE, 1, -1.8f, new FabricItemSettings().fireproof()));
    public static final Item OBSIDIAN_INFUSED_ENDERITE_AXE = registerItem("obsidian_infused_enderite_axe",
            new AxeItem(ToolMaterialsInit.OBSIDIAN_INFUSED_ENDERITE, 5, -2f, new FabricItemSettings().fireproof()));
    public static final Item OBSIDIAN_INFUSED_ENDERITE_HOE = registerItem("obsidian_infused_enderite_hoe",
            new HoeItem(ToolMaterialsInit.OBSIDIAN_INFUSED_ENDERITE, -6, 1f, new FabricItemSettings().fireproof()));

    public static final Item ENDERITE_PLATED_ELYTRA = registerItem("enderite_plated_elytra",
            new EnderitePlatedElytraItem(3, new FabricItemSettings().fireproof().maxDamage(972).rarity(Rarity.RARE)));
