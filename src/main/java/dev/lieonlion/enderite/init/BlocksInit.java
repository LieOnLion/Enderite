...
public class BlocksInit {
    public static final Block ENDERITE_BLOCK = registerBlock("enderite_block",
            new Block(FabricBlockSettings.create().mapColor(MapColor.MAGENTA).strength(60, 1300).requiresTool().sounds(BlockSoundGroup.NETHERITE)));
    public static final Block PRIMORDIAL_REMNANTS = registerBlock("primordial_remnants",
            new Block(FabricBlockSettings.create().mapColor(MapColor.MAGENTA).strength(40, 1100).requiresTool().sounds(BlockSoundGroup.METAL)));
